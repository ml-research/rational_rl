...
# for game in "Asterix"
for game in "Asterix" "BattleZone" "Enduro" "Jamesbond" "Kangaroo" "Pong" "Qbert" "Seaquest" "Skiing" "SpaceInvaders" "Tennis" "TimePilot" "Tutankham" "VideoPinball"
do
  ffmpeg -i DQN_lrelu_$game*.gif -i DQN_rat_$game*.gif -i DQN_recrat_$game*.gif -lavfi "hstack=inputs=3,fps=10" $game.gif
  gifopt $game.gif 80 64 0.6
  rm $game.gif
done
